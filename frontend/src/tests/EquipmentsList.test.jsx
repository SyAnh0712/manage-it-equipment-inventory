...
const mockEquipments = [
  { id: 1, code: 'EQ001', name: 'Laptop Dell', unit: 'Cái', quantity: 10, price: 1200 },
  { id: 2, code: 'EQ002', name: 'Monitor LG 24', unit: 'Cái', quantity: 5, price: 200 },
  { id: 3, code: 'EQ003', name: 'Keyboard Logitech', unit: 'Cái', quantity: 15, price: 50 },
];
...
describe('EquipmentsList Page', () => {
  ...
  it('filters equipment list correctly based on search term', async () => {
    ...
    const searchInput = screen.getByPlaceholderText(/search by code, name or unit/i);
